...
public class OrleansSerializerDeflate : Serialization.OrleansSerializer
{
	public OrleansSerializerDeflate(SerializationManager serializationManager) : base(serializationManager)
	{
	}
